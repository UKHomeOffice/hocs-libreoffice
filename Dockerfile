...
# set up libreOffice
RUN curl -O http://mirrors.coreix.net/thedocumentfoundation/libreoffice/stable/6.4.7.2/rpm/x86_64/LibreOffice_6.4.7.2_Linux_x86-64_rpm.tar.gz
RUN tar zxvf LibreOffice_6.4.7.2_Linux_x86-64_rpm.tar.gz
